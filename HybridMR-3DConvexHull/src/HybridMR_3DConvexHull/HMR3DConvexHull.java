...
/******************************************************************************/
  ...
  public static void main(String[] args) throws Exception {
      ...
      while (CurrentCount!=PreviousCount) {
          ...
          System.out.println("***************************************************");
          System.out.println("Hybird MapReduce 3D Convex Hull Iteration >> "+count);
          System.out.println("***************************************************");
          ...
          job7.setJarByClass(HMR3DConvexHull.class);
          ...
          if ((OutputRec<=10000000)&&(OutputRec!=0)){
      ...
      if (FastPass==true){
          ...
          job8.setJarByClass(HMR3DConvexHull.class);
          ...
          job8.waitForCompletion(true);
            ...
            System.out.println("Sorry !!! The data set is too big !!! Try to increase the threshold.");
